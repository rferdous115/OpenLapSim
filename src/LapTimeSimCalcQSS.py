...
class LapTimeSimCalcQSS:
    ...
    def Run(self):
        ...
        self.GGVacc, self.GGVdec = LapTimeSimCalcQSS.splitGGVfull(self.GGVfull)
        ...
        for i in range(len(dist)-1):
            ...
            axcombine[i] = LapTimeSimCalcQSS.GGVSurfInterp(vxacc[i], ayreal[i],
                                                        X, Y, Z)
        ...
        for i in reversed(range(len(dist))):
            ...
            axcombine[i] = LapTimeSimCalcQSS.GGVSurfInterp(vxdec[i], ayreal[i],
                                                        X, Y, Z)
        ...
        print("LapSimTimeCalcQSS work in process")
